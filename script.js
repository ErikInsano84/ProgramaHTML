...
function evaluarTest(){
    ...
    if (q1 === "cansado"){
        rutina = "Hoy te recomiendo una rutina ligera de estiramientos y respiracion.";
    }else if (q1 === "energetico" && q2 === "30 min" && q3 === "cardio"){
        rutina = "Rutina de cardio intenso: saltos, burpees y carrera en el lugar.";
    }else if (q4 === "si" && q5 === "avanzado"){
        rutina = "Rutina de fuerza con pesas: press de banca, sentadillas y dominadas.";
    }else{
        rutina = "Rutina basica de cuerpo libre: flexiones, sentadillas y planchas.";
    }
